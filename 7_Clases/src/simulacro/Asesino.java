...
public class Asesino {
    ...
    public String toString() {
        return String.format("%-20s %-12d %-8d %-8s", getNombre(), inteligencia, suerte, (isLicencia ? "SI" : "NO"));
    }
    
    public int calcularPuntuacionCombate() {
        int bonusLicencia = isLicencia ? 5 : 0;
        int random = rnd.nextInt(10) + 1; // 1-10
        return inteligencia + suerte + bonusLicencia + random;
    }
