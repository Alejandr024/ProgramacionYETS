...
public class Superheroe {
    ...
    public String toString() {
        return "Superheroe{" + "nombre=" + nombre + ", comicTipo=" + comicTipo + ", fuerza=" + fuerza + ", idSecreta=" + idSecreta + ", arrayVillanos=" + Arrays.toString(arrayVillanos) + ", arrayComic=" + Arrays.toString(arrayComic) + '}';
    }
