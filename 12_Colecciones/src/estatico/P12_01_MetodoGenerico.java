...
public class P12_01_MetodoGenerico {
   ...
   System.out.println("--- 1. PRUEBAS CON STRINGS ---");
     ...
     * IMPORTANTE: En los m?todos est?ticos gen?ricos, el par?metro de tipo <E> 
    ...
    /**
     * VERSI?N 1 (Did?ctica): Concatena iterando y reutilizando el m?todo append.
     * Es m?s lenta porque crea un array nuevo en cada iteraci?n de memoria.
     */
    ...
    /**
     * VERSI?N 2 (Profesional): Concatena usando copiado directo de memoria.
     * Es la forma m?s eficiente de unir arrays en Java.
     */
