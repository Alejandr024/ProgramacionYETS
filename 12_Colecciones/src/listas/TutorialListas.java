...
public class TutorialListas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Posición donde encuentra el ultimo elemento con valor 3: " + lista.lastIndexOf(3));
        ...
        Comparator<Double> comparadorDouble = new Comparator<Double>() {
            ...
            public int compare(Double num1, Double num2) {
                return Double.compare(num2, num1); // cambiar a 'num1 - num2' para orden ascendente
            }
        };
