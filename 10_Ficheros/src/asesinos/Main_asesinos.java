...
public class Main_asesinos {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. Agregar asesino");
            ...
            System.out.println("6. Agregar los asesinos a un fichero");
            ...
            switch (opcion) {
                case 1:
                    System.out.println("=== Agregar asesino ===");
                    System.out.print("Nombre: ");
                    String nombre = sc.nextLine();

                    System.out.print("¿Quieres introducir atributos manualmente? (s/n): ");
                    ...
                    if (resp.equals("s")) {
                        ...
                        sc.nextLine(); // limpiar
                        System.out.print("¿Tiene licencia gubernamental? (s/n): ");
                    ...
                    System.out.println("Asesino añadido.\n");
                    break;
                ...
                case 5:
                    ...
                    while (!sc.hasNextInt()) {
                        System.out.print("Introduce un indice valido: ");
                        sc.next();
                    }
                    int idx = sc.nextInt();
                    sc.nextLine(); // limpiar
                    ...
                    if (as == null) {
                        System.out.println("No hay asesino en ese índice.");
                    } else {
                        as.mostrarCombates();
                    }
                    break;
                ...
                case 6:
                    System.out.println("Agregando los asesinos a un ficheros...");
                    organizacion.backUp(arrayBase);
                    break;
